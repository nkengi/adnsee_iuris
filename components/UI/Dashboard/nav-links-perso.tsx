...
import Image from 'next/image';
  ...
  // const AccountType = "perso";
  
  // Map of links to display in the side navigation.
  // Depending on the size of the application, this would be stored in a database.
  const links = [
    { name: 'Home', href: '/dashboard/perso', icon: "/svg/dashboard-3.svg" },
    {
      name: 'Process',
      href: '/dashboard/perso/process',
      icon: "/svg/flowchart-hierarchy-process-2.svg",
    },
    { name: 'Settings', href: `/dashboard/perso/settings`, icon: "/svg/settings-gear.svg" },
  ];
